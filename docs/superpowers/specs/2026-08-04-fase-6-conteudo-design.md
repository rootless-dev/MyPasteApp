...
| Amostragem no preview: cria item? | ~~**Não. Só copia**~~ → **Sim, cria**, como os outros dois caminhos de cor | **Revertido na verificação manual do Carlos.** O argumento original era que clicar em vários pixels encheria o histórico, e que amostrar é "olhar de perto o que já está dentro" — diferente de capturar da tela. Em uso a distinção não se sustentou: uma cor que se foi procurar dentro de uma imagem é uma cor que se quer de volta, e ter dois dos três caminhos de cor arquivando enquanto o terceiro silenciosamente não arquivava era impossível de explicar. A preocupação original fica coberta por `ClipboardMonitor.file`, que promove o item existente em vez de duplicar quando a mesma cor é amostrada de novo |
